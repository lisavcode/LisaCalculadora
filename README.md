...
## 📅 Última Atualização (v1.3.1) - 05/03/2026
- Adicionado painel de customização de cores mais organizado com categorias expansíveis.
- Novo recurso 'Travar/Destravar Categoria' (Cadeado em massa).
- Adicionado suporte a personalização de cores para botões de ação e insígnias de Eras.
- Novo controle global de 'Brilho' (Lightness).
- Sincronização de Matiz (Hue) estendida para itens de navegação e textos globais.
